...
exports.ResourcesModule = ResourcesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [room_service_1.RoomService, subject_service_1.SubjectService, teacher_service_1.TeacherService],
        exports: [room_service_1.RoomService, subject_service_1.SubjectService, teacher_service_1.TeacherService]
    })
], ResourcesModule);
