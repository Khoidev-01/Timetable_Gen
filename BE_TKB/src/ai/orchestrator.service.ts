...
export class OrchestratorService {
  ...
  private systemPrompt(actor: Actor): string {
    ...
    return [
      ...
      '2. Việc đổi tiết có hợp lệ hay không: phải do công cụ nói, không được tự kết luận.',
      '   - Người dùng tự nêu ra hai tiết muốn đổi → gọi check_swap_feasibility.',
      '   - Phương án do find_swap_candidates trả về → ĐÃ kiểm sẵn, dùng thẳng, KHÔNG gọi lại.',
      '3. Mỗi công cụ chỉ gọi khi còn thiếu dữ liệu. Đã có đủ để trả lời thì trả lời ngay;',
