...
export const SUBJECT_CATALOG: SubjectCatalogItem[] = [
  ...
  { code: 'GDTC', name: 'Giáo dục thể chất', group: 'Bắt buộc', aliases: ['THEDUC', 'THECHAT'], isPractice: true },
  ...
  { code: 'LY', name: 'Vật lý', group: 'Lựa chọn', aliases: ['VL', 'VATLY'], isPractice: true },
  { code: 'HOA', name: 'Hóa học', group: 'Lựa chọn', aliases: ['HOAHOC', 'HH'], isPractice: true },
  { code: 'SINH', name: 'Sinh học', group: 'Lựa chọn', aliases: ['SH', 'SINHHOC'], isPractice: true },
  ...
  { code: 'TIN', name: 'Tin học', group: 'Lựa chọn', aliases: ['TH', 'TINHOC'], isPractice: true },
  {
    code: 'CHAO_CO',
    name: 'Chào cờ',
...
export const GUIDE_ROWS: Array<[string, string]> = [
  ...
  [
    'Tiết HK1/HK2',
    'Nhập TỔNG số tiết của cả học kỳ (ví dụ Ngữ văn = 54 tiết HK1). ' +
      'Hệ thống tự quy đổi ra số tiết mỗi tuần theo số tuần thực học của học kỳ.',
  ],
