        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-[var(--bg-surface)] rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div>
                        <h4 className="text-lg font-semibold text-[var(--text-secondary)] mb-3 flex items-center gap-2">
                            📚 Giảng dạy
                        </h4>
                        <div className="bg-[var(--bg-surface-hover)] p-4 rounded-lg border border-[var(--border-default)] mb-4 grid grid-cols-4 gap-3 items-end">
                            <div>
                                <label className="text-xs font-medium text-[var(--text-muted)]">Môn học</label>
                            ...
                            <div>
                                <label className="text-xs font-medium text-[var(--text-muted)]">Lớp</label>
                            ...
                            <div>
                                <label className="text-xs font-medium text-[var(--text-muted)]">Số tiết/tuần</label>
                            ...
                            <div className="flex gap-2">
                                ...
                                {editingAssignmentId && (
                                    <button onClick={cancelEditAssignment} className="bg-gray-400 text-white p-2 rounded hover:bg-[var(--bg-surface-hover)]0">
                                        Hủy
                                    </button>
                                )}
                            </div>
                        ...
                        <table className="w-full text-sm text-left border rounded overflow-hidden">
                            ...
                            <tbody>
                                {assignments.length === 0 ? <tr><td colSpan={4} className="p-3 text-center text-[var(--text-muted)]">Chưa có phân công</td></tr> :
                                    assignments.map(a => (
                    ...
                    <div>
                        ...
                        <div className="bg-[var(--bg-surface-hover)] p-4 rounded-lg border border-[var(--border-default)] mb-4 grid grid-cols-4 gap-3 items-end">
                            <div className="col-span-2">
                                <label className="text-xs font-medium text-[var(--text-muted)]">Tên nhiệm vụ</label>
                            ...
                            <div>
                                <label className="text-xs font-medium text-[var(--text-muted)]">Số tiết quy đổi</label>
                            ...
                            <div className="flex gap-2">
                                ...
                                {editingDutyId && (
                                    <button onClick={cancelEditDuty} className="bg-gray-400 text-white p-2 rounded hover:bg-[var(--bg-surface-hover)]0">
                                        Hủy
                                    </button>
                                )}
                            </div>
                        ...
                        <table className="w-full text-sm text-left border rounded overflow-hidden">
                            ...
                            <tbody>
                                {duties.length === 0 ? <tr><td colSpan={3} className="p-3 text-center text-[var(--text-muted)]">Chưa có kiêm nhiệm</td></tr> :
                                    duties.map(d => (
